...
namespace Shaligram_Recruitment.Common.EmailNotification
{
    public class EmailNotification
    {
        ...
        public static bool SendMailMessage(string recipient, string bcc, string cc, string subject, string body, EmailSetting emailSetting, string attachment)
        {
            ...
            try
            {
                ...
                smtpClient.Credentials = new System.Net.NetworkCredential(emailSetting.FromEmail, emailSetting.EmailAppPassword);
                //var smtpClient = new SmtpClient("smtp.yourserver.com")
                //{
                //    Port = 587, // Common ports: 25, 587, or 465 (for SSL)
                //    Credentials = new NetworkCredential("your-email@example.com", "your-email-password"),
                //    EnableSsl = true, // Enable SSL if the server requires it
                //};
